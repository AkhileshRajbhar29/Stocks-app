        ...
        <div className='container'>
            <div className="row p-5 mt-5 mb-5">
                <h1 className='fs-2 text-center'>
                    We pioneered the discount roking model in Indea
                    <br />
                    Now, we are breaking grund with our technology.
                </h1>
            </div>
            <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight:"1.8", fontSize:"1.2em"}}>
                <div className='col-6 p-5'>
                    ...
                    <p>
                        Over 1.8+ crore clients place billions of orders every year through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.
                    </p>
                </div>
                <div className='col-6 p-5'>
                    <p>
